// =============================================================================
// API: sync/contas-pagar - port FIEL de POST /api/sync/contas-pagar do
// server.js (linhas 4120-4123). Rota de compatibilidade: o original
// reescrevia req.url e reroteava para /api/sync/conta. Aqui replicamos o
// MESMO comportamento de /api/sync/conta (sempre pagar + receber para a conta).
// =============================================================================
