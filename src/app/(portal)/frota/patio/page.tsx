...
export default function FrotaPatioPage() {
  ...
  const recarregar = useCallback(() => {
    ...
    ;(async () => {
      try {
        const r = await fetch('/api/visual-estoque/frota', { headers: await authHeaders() })
  ...
  // O gate da tela é do frota/layout.tsx (frota:patio; a chave legada
