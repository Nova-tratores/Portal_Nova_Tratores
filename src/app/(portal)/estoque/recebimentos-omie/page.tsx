...
export default function RecebimentosPage() {
  ...
  if (!permLoading && userProfile && !pode('estoque', 'recebimentos-omie')) return <SemPermissao />;
    ...
    <div style={{ maxWidth: 1400, margin: '0 auto', padding: '20px 24px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ color: '#888', fontSize: '.82rem', marginBottom: 0 }}>Recebimento de NF-e de fornecedor — espelho do Omie (pendentes e concluídos). Concluir/Reabrir escrevem no Omie.</p>
        </div>
        <ContaSelector />
      </div>
