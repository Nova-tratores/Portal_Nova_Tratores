      ...
      {aberto && (
        <div className="fixed inset-0 z-[95] flex justify-end print:hidden" onClick={() => setAberto(false)}>
          ...
          <div className="relative w-[440px] max-w-[92vw] h-full bg-white shadow-2xl flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 py-5 border-b border-zinc-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">Pedidos de permissão</p>
                </div>
              </div>
            ...
            <div className="px-4 py-2 border-b border-zinc-100 flex items-center gap-2 text-sm font-semibold text-zinc-600">
              <Bell size={15} /> Pendentes {pendentes.length > 0 && <span className="text-[11px] bg-red-600 text-white px-1.5 rounded-full">{pendentes.length}</span>}
            </div>
